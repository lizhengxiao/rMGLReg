...
#' #' @importFrom fCopulae pellipticalCopula
#' #' @importFrom fCopulae pevCopula
...
#'     as.numeric(fCopulae::pellipticalCopula(U, rho = param[1], type = "norm")) # normal copula
#'   ptcop <- function(U, param)
#'     as.numeric(fCopulae::pellipticalCopula(U, rho = param[1], type = "t",
#'                                  param = param[2]))  # t copula
#'   pgumcop <- function(U, param)
#'     as.numeric(fCopulae::pevCopula(U, type = "gumbel", param = param[1])) # Bivariate Extreme Value Copulae - gumbel copula
