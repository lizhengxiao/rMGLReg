...
- contain code to reproduce the output of the proposed methods described in the paper: [A new class of copula regression models for modelling multivariate heavy-tailed data](https://arxiv.org/abs/2108.05511). 
