...
- To access documentation for the properties of the proposed copula ``dcMGL.multi`` (density function), `pcMGL.multi` (distribution function), ``rcMGL.multi`` (random generation);
